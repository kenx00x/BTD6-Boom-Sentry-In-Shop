...
using MelonLoader;
using System.IO;
[assembly: MelonInfo(typeof(BTD6_Boom_Sentry_In_Shop.Class1), "Boom Sentry In Shop", "1.0.0", "kenx00x")]
...
namespace BTD6_Boom_Sentry_In_Shop
{
    public class Class1 : MelonMod
    {
        ...
        {
            MelonLogger.Log("Boom Sentry In Shop mod loaded");
        ...
        public class ProfileModel_Patch
        {
            ...
            public static void Postfix(ProfileModel __instance)
            {
                ...
                {
                    MelonLogger.Log("Boom Sentry already unlocked");
                }
                else
                {
                    MelonLogger.Log("unlocking Boom Sentry");
